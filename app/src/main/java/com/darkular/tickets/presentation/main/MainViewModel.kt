...
import com.darkular.tickets.presentation.group.create.films.FilmsFragment
...
class MainViewModel(
    ...
    private val idMap = mapOf(
        ...
        R.id.select_group_film_screen to FilmsFragment::class.java
...
//        changeScreen(R.id.navigation_profile)
    }
}